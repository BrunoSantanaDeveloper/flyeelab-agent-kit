...
#### 🛑 PHASE 0: CONTEXT & TDD CHECK (CRITICAL)
...
#### 🧠 TDD CONSUMPTION RULES (The "Waldemar" Flow)
...
#### 🔴 PLAN FILE NAMING
(Mantém a mesma lógica original do antigravity-kit)
...
> **📌 TDD Infra Section:** When TDD has Section 10 (Infraestrutura), use it as source of truth for environment setup.
